...
[![Deploy with Vercel](javascript:alert();//https://vercel.com/button)](javascript:alert();//https://vercel.com/new/clone?repository-url=https://github.com/vercel/vercel/tree/main/examples/hugo&template=hugo)
